    ...
    <div id="add-property" class="container">
        <div class="well">
            <form method="POST">
                ...
                <div class="form-group">
                    <button type="submit" name="forgotpass" class="btn btn-default btn-block">Submit</button>
                                    
                        <!--<a href="changepass.php" role="button" class="btn btn-primary btn-block">Submit</a>-->
                    </div>
            </form>
        </div>
    </div>
